...
Senior software developer, working in both frontend and backend.
...
Analyst Programer, working in Sener in FORAN project. CAD/CAE/CAM software for ship design.
Developed for 50+ years. Working in the electricity subsystem
...
Developer. Working in Auna SGI project (Sistema de gestion integrado). Working in two subsystems:
SIR (Sistema de Inventario de red)
